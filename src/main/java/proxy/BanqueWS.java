 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://Server/", wsdlLocation = "http://localhost:8787/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://Server/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://Server/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Server/", "BanqueServicePort"), BanqueService.class, features);
    }
